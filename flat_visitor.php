<?php
/* This code is a PHP script that displays a table of flat visitors. */
...
<body id="body-pd">
    ...
    ?>
    <div class="container">
        <h3 class="text-center">Flat Visitors</h3>
        <hr>
    <?php
    $select = "SELECT v_id, v_name, v_contact, v_date FROM visitors WHERE v_wing = '$wing' AND v_flat = '$flat_number' AND v_floor = '$floor_number'";
