<?php
/* The code you provided is a PHP script that displays a table of notice for a logged-in user. */
...
$select = "SELECT n_name, n_sub, notice_type, date, message FROM notice WHERE member_id ='$member_id' || member_id = '0'";
