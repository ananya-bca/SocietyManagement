<?php
/* The code is a PHP script that displays a web page for managing notice. */
...
<body id="body-pd">
    ...
    <div class="container">
        ...
        <hr>
        <div class="add">
            <a href="add_notice.php" class="btn" style="background-color:#435B66">+Add notice</a>
        </div>
