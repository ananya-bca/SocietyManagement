<?php
/* This code is a PHP script that generates an HTML page for managing visitors.*/
...
<div class="container">
  ...
  <hr>
  <div class="add">
    <a href="add_visitor.php" class="btn" style="background-color:#435B66">+Add visitor</a>
  </div>
