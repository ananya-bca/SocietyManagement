<?php
/* The code you provided is a PHP script that displays a table of bills for a logged-in user. */
...
$select = "SELECT bill_id, bill_type, charge, last_date, status FROM bills WHERE member_id ='$member_id'";
