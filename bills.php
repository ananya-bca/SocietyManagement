<?php
/* This code is a PHP script that generates an HTML page for managing bills.*/
...
<body id="body-pd">
    ...
    <div class="container">
        ...
        <hr>
        <div class="add">
            <a href="send_bill.php" class="btn" style="background-color:#435B66">+Add bill</a>
        </div>
